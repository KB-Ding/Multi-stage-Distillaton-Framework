...
class parallel_all_emb_dataset(Dataset):
    ...
    def __init__(self, config, mode, encoding="utf8"):
        ...
        auto_model = teacher_model._first_module().auto_model
        layers_to_keep = []
        logx.msg(infor_msg("Remove layers from teacher. Only keep these layers: {}".format(layers_to_keep)))
