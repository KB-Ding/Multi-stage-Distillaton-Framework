...
class MSEEvaluatorFromDataFrame(SentenceEvaluator):
    ...
    :param dataframe:
        ...
        [{'en': 'My sentence', 'es': 'multilingual in Spanisch', 'fr': 'multilingual in French'...},
    ...
    :param combinations:
        ...
        Second entry in a tuple the the target language. multilingual will be fetched from the dataframe and passed to the student model
    """
