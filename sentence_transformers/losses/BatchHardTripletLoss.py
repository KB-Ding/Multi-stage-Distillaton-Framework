...
class BatchHardTripletLoss(nn.Module):
    ...
    Example::
       ...
       train_examples = [InputExample(texts=['multilingual from class 0'], label=0), InputExample(texts=['Another sentence from class 0'], label=0),
           InputExample(texts=['multilingual from class 1'], label=1), InputExample(texts=['multilingual from class 2'], label=2)]
