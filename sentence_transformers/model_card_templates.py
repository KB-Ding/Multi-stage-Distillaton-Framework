...
## Usage (multilingual-Transformers)
...
For an automated evaluation of this model, see the *multilingual Embeddings Benchmark*: [https://seb.sbert.net](https://seb.sbert.net?model_name={MODEL_NAME})
